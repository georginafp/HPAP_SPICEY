...
# --- POSTER CONTENT --- #
main_findings:
  - "![](figs/main_spicey_white.png){ width=90% }"
...
# --- COLOURS --- #
primary_colour: "#684548"       # Main background
accent_colour: "#926164"        # Highlighted sections
secondary_colour: "#3a4d34"     # Contrast/pop elements
body_bgcol: "#ffffff"
body_textsize: "40pt"
body_fontfamily: "Lato"
body_textcol: "#000000"
reference_textsize: "35pt"
...
prom <- bind_rows(
  ...
  scale_color_manual(values = c(
    "Ubiquitous_RETSI" = "#516c48",
    "Ubiquitous_GETSI" = "#516c48",
    "Tissue-specific_RETSI" = "#926164",
    "Tissue-specific_GETSI" = "#926164"
  )) +
  scale_fill_manual(values = c(
    "Ubiquitous_RETSI" = "#8da17f",
    "Ubiquitous_GETSI" = "#8da17f",
